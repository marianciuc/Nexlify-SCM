...
public abstract class UnauthorizedException extends BusinessException {
  ...
  private static final String ERROR_CODE_PREFIX = "UNAUTHORIZED_";
  private static final HttpStatus DEFAULT_STATUS = HttpStatus.UNAUTHORIZED;
  private static final String DEFAULT_MESSAGE = "error.security.unauthorized";

  public UnauthorizedException(String message, String domain) {
